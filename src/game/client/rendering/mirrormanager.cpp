...
void CMirrorManager::SetupClipping(void)
{
	...
	vDist = m_pCurrentMirror->origin - m_pMirrorParams.vieworg;
...
void CMirrorManager::SetupMirrorPass(void)
{
	...
	AngleVectors(m_pViewParams->viewangles, forward, right, up);
  ...
  m_pMirrorParams.cl_viewangles = m_pMirrorParams.viewangles;
